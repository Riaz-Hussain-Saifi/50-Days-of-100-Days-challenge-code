...
const oneDay = 1000 * 60 * 60 * 24; // There are 1000 milliseconds in a second, 60 seconds in a minute, 60 minutes in an hour, and 24 hours in a day.
const daysLeft = Math.ceil((newYear.getTime() - today.getTime()) / oneDay); //  This calculates the difference between the newYear date and the today date in milliseconds, then converts it into days by dividing by oneDay. Math.ceil is used to round up to the nearest whole number to ensure we get the remaining days until New Year.
